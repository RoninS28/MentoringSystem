    ...
    <%@ page import="java.util.ArrayList, java.io.*" %>
        ...
        <nav style="margin-bottom: 50px;">
            ...
            <ul>
                ...
                <li><a href="/MentoringSystem/NoticePage?regid=${regid}" class="active">MY NOTICES</a></li>
        ...
        <div class="content">
            ...
            <% ArrayList<String> contentlist = (ArrayList<String>) request.getAttribute("notices");
                    ArrayList<String> timestamplist = (ArrayList<String>) request.getAttribute("timestamps");
                            ...
                            for(int i=0; i<contentlist.size(); i++){ String noticeContent=contentlist.get(i).toString();
                                String mytimestamp; if(timestamplist.get(i)==null){ mytimestamp="27/05/2021 17:00" ;}
